...
-- admin
INSERT INTO users (name, email, password, calories_per_day, email_confirmed)
VALUES ('User', 'user@yandex.ru', '$2a$10$Sh0ZD2NFrzRRJJEKEWn8l.92ROEuzlVyzB9SV1AM8fdluPR0aC1ni', 2005, true);

-- password
INSERT INTO users (name, email, password, calories_per_day, email_confirmed)
VALUES ('Admin', 'admin@gmail.com', '$2a$10$WejOLxVuXRpOgr4IlzQJ.eT4UcukNqHlAiOVZj1P/nmc8WbpMkiju', 1900, true);
