...
<head>
    ...
    <link rel="stylesheet" href="webjars/chosen-bootstrap/1.1.0/chosen.bootstrap.css">
    ...
    <script type="text/javascript" src="webjars/chosen/1.8.3/chosen.jquery.js" defer></script>
</head>