								...
								<form class="form-horizontal" id="filter">
									<div class="form-group">
										<label class="control-label col-sm-2"
										       for="startDate"><spring:message
												code="meals.startDate"/>:</label>
										
										<div class="col-sm-4">
											<input onclick="datePicker(this)" class="form-control"
											       type="text"
											       name="startDate"
											       id="startDate">
										</div>
										...
										<div class="col-sm-3">
											<input onclick="timePicker(this)" class="form-control" type="text" name="startTime"
											       id="startTime">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-2"
										       for="endDate"><spring:message
												code="meals.endDate"/>:</label>
										
										<div class="col-sm-4">
											<input onclick="datePicker(this)" class="form-control" type="text" name="endDate"
											       id="endDate">
										</div>
										
										<label class="control-label col-sm-3"
										       for="endTime"><spring:message
												code="meals.endTime"/>:</label>
										
										<div class="col-sm-3">
											<input onclick="timePicker(this)" class="form-control" type="text" name="endTime"
											       id="endTime">
										</div>
									</div>
								</form>
				...
				<form class="form-horizontal" id="detailsForm">
					...
					<div class="form-group">
						...
						<div class="col-xs-9">
							...
							<input onclick="showDateTimePicker(this)" type="text"
							       class="form-control"
							       id="dateTime"
							       name="dateTime"
